!function (l, e, n, r) {
    ...
    c.prototype = {
        ...
        _show: function (t, e) {
            var o = t.data(a), n = this.items.get(o), s = t.data("flashy-type") || n.config.type,
                i = t.data("flashy-href") || t.attr("href"), l = this;
        ...
        _loadVideo: function (t, e, o) {
            ...
            var n = this._parseVideoUrl(o), s = null,
        ...
        return "instance" == i ? u() : (h++, this.each(function () {
            var t = u(), e = l(this), o = h, n = l.isPlainObject(i) ? i : {},
