        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                <ul class="navbar-nav" style="position: relative">
                    ...
                    <li class="dropdown" style="position: unset">
                        <a class="dropdown-toggle" href="#" id="dr_ipad" data-toggle="dropdown">
                            ipad
                        </a>
                        <div class="dropdown-menu">
                            <div class="row">
                    ...
                    <li class="dropdown" style="position: unset">
                        <a class="dropdown-toggle" href="#" id="dr_mac" data-toggle="dropdown">
                            mac
                        </a>
                        <div class="dropdown-menu">
                            <div class="row">
                    ...
                    <li class="dropdown" style="position: unset">
                        <a class="dropdown-toggle" href="#" id="dr_watch" data-toggle="dropdown">
                            watch
                        </a>
                        <div class="dropdown-menu">
                            <div class="row">
                    ...
                    <li><a href="#home" id="dn-index">ĐĂNG NHẬP</a></li>
