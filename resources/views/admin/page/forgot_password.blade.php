...
<div class="fp-box">
    <div class="logo">
        <a href="javascript:void(0);">Đặt lại mật khẩu Admin<b> itamloan</b></a>
    </div>
    <div class="card">
        <div class="body">
            <form id="forgot_password" action="{{route('postquenmk')}}" method="POST">
                {{ csrf_field() }}
                <div class="msg">
                    Nhập địa chỉ email của admin. <br>Mật khẩu mới sẽ được gửi vào email.
                </div>
